...
class LossFeatureExtractorInceptionV3(FeatureExtractorBase):
    ...
    def __init__(
        ...
        """
        super(LossFeatureExtractorInceptionV3, self).__init__(name, features_list)
...
def get_inception_loss_model():
    model = LossFeatureExtractorInceptionV3("inception_model", ["2048"])
    return model