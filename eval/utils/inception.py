...
class FeatureExtractorInceptionV3(FeatureExtractorBase):
    ...
    def __init__(
        ...
        state_dict = load_state_dict_from_url(FID_WEIGHTS_URL, progress=True, model_dir="/mnt/shared-storage-user/jianglihan/myc/code/One-D-Piece2/pretrained_weight")
