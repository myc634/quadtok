...
def unpack(base_dir, 
           ...
           class_json='/mnt/shared-storage-user/jianglihan/myc/code/One-D-Piece/data/reformat_val/ImageNet_class_index.json',
           val_label='/mnt/shared-storage-user/jianglihan/myc/code/One-D-Piece/data/reformat_val/ImageNet_val_label.txt'):
    ...
    target_val_dir   = os.path.join(target_dir, 'ILSVRC2012_validation')
...
if __name__ == '__main__':
    base_dir   = '/mnt/shared-storage-user/idc2-shared/dataset/raw/imagenet-val'
    target_dir = '/mnt/shared-storage-user/idc2-shared/dataset/raw/imagenet-val'
