...
class LPIPS(nn.Module):
    ...
    def load_pretrained(self):
        # VGG_PATH = get_ckpt_path("vgg_lpips", os.path.join("pretrained_weight/vgg_lpips.pth"), check=True)
        VGG_PATH = "pretrained_weight/vgg.pth"
...
class vgg16(torch.nn.Module):
    def __init__(self, requires_grad=False, pretrained=True):
        ...
        weights_path = 'pretrained_weight/vgg16-397923af.pth' 
        state_dict = torch.load(weights_path, map_location='cpu') 
        vgg_pretrained.load_state_dict(state_dict)
