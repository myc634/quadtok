...
rclone  copy --progress --transfers 200 --checkers 200 --links /mnt/petrelfs/jianglihan/my_code/quadtok3/checkpoints/generator/gpt_quadtree_base_tokenizerv4/checkpoint-180000/ema_model/pytorch_model.bin gdrive:quadtok/gpt_base_tokenzierv3_expandprob075