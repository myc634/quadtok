...
launcher="accelerate launch \
  ...
  --config checkpoints/generator/gpt_quadtree_base_16kcodebook_2lod_base_decay2x_4e-4lr/config.yaml \
  --num_samples 50000 \
  --batch_size 64 \
  --checkpoint checkpoints/generator/gpt_quadtree_base_16kcodebook_2lod_base_decay2x_4e-4lr/checkpoint-140000/ema_model/pytorch_model.bin"
